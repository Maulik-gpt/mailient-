...
const ARCUS_MODEL = 'liquid/lfm-2.5-1.2b-thinking:free';
...
export class ArcusAIService {
    ...
    /**
     * Call OpenRouter API - NO FALLBACKS as requested
     */
    async callOpenRouter(messages, options = {}) {
        const modelId = this.model || ARCUS_MODEL;
        ...
        try {
            ...
            if (!response.ok) {
                ...
                console.warn(`❌ Arcus API Error (${response.status}) for ${modelId}: ${errorDetail.substring(0, 100)}`);
