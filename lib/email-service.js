...
/* ─────────────── LANDING HOOK — opt-in capture on mailient.xyz ───────────────
 *
...
export function buildLandingHookEmail() {
  ...
  const content = `
    ...
    ${UI.p(`Mailient reads the inbox overnight, drafts the replies in your voice, books the calls, and leaves you one briefing in the morning. Nothing sends without your approval.`)}
  ...
  return EmailUI.shell({
    ...
    footerNote: 'You left your email on mailient.xyz — that is the only reason this reached you.',
  });
}
