...
export class AIConfig {
  ...
  async generateInboxIntelligence(gmailData) {
    ...
    return await this.openrouterService.generateInboxIntelligence(gmailData);
  }

  /**
   * Generate chat response
   */
  async generateChatResponse(userMessage, emailContext = null, session = null) {
    if (!this.openrouterService) {
      throw new Error('OpenRouter service not available');
    }

    return await this.openrouterService.generateChatResponse(userMessage, emailContext, session);
  }
  ...
  async generateEmailSummary(emailContent) {
    ...
    return await this.openrouterService.generateEmailSummary(emailContent);
  }
  ...
  async generateDraftReply(emailContent, category, userContext = {}) {
    ...
    return await this.openrouterService.generateDraftReply(emailContent, category, userContext);
  }
