 ...
 *    the client guess.
 *  - No web fonts. Fontshare/Google font links fail silently in most clients and
 *    cost a render round-trip; the system stack below is what Apple Mail and
 *    Gmail actually use for their own UI.
 */
...
<head>
  ...
  <![endif]-->
  <style>
    /* Progressive enhancement ONLY. Gmail may drop this entire block. */
