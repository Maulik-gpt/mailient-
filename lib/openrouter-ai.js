...
export class OpenRouterAIService {
    ...
    async generateInboxIntelligence(gmailData, privacyMode = false) {
        ...
        const prompt = `Analyst. Analyze the provided emails and categorize them into these exact categories: [${categories.join(', ')}].
Return ONLY valid JSON in this exact format:
{
  "opportunity": {
    "summary": "Short 1-sentence summary",
    "description": "A beautiful, premium, highly readable description formatted in Markdown. Use bullet points and bold text. IMPORTANT: Ensure this is a valid JSON string (escape internal quotes with \\\").",
    "relevance": 8,
    "ids": ["1", "2"]
  }
}
Provide an entry for each category. If no emails match a category, leave its "ids" array empty. Output ONLY the raw JSON string without markdown code blocks.
...
EMAILS:\n${emailList}`;
        ...
        try {
            ...
            // Clean up common markdown formatting around JSON
