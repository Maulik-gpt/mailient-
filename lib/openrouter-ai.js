                                    ...
                                    if (content) {
                                        ...
                                        if (!isInsideThink) {
                                            if (isInsideEmail) {
                                                ...
                                                // We wait for a small buffer to avoid outputting partial tags
...
3. Keep it to 3-4 sentences that sound human, not like an AI summary.
...
7. CRITICAL: Deliver exactly 3-4 sentences of deep insight. No more, no less.`
                },
