...
1. DEEP THINKING: First, deeply consider ${fromName}'s state of mind, intent, and what ${userName} (given their role) should naturally communicate. Put your entire reasoning process inside <think> and </think> tags.
2. OUTPUT ONLY THE FINAL EMAIL TEXT inside <email> and </email> tags. No meta-commentary outside of <think> tags.
3. FORBIDDEN: Do not invent a corporate tone if the profile is casual. Match the profile perfectly.
4. You MUST strictly use ONLY the precise greetings and sign-offs explicitly listed in the voice profile. Do NOT invent new ones.
5. If the voice profile indicates lowercase-heavy or omitted periods, you MUST apply that exact formatting.
6. Address the context of the email clearly and efficiently.
7. Maximum ${tone === 'concise' ? '50' : '150'} words. No em dashes (use commas/periods).

OUTPUT FORMAT (Must be exactly this structure):
<think>Your deep analysis of the sender, recipient, and the specific dynamics here...</think>
...
4. Keep the email well-formatted (paragraphs, proper capitalization).
5. Address the overall context of the email directly and professionally.
