...
export class OpenRouterAIService {
    ...
    constructor() {
        // Standardized strictly on the requested fast flash model to guarantee speed
        ...
        this.specializedModel = 'deepseek/deepseek-v4-flash:free';
        this.voiceCloningModel = 'deepseek/deepseek-v4-flash:free';
