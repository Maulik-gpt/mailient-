...
export class OpenRouterAIService {
    ...
    static premiumModels() {
        ...
        // gemini-2.5-flash-lite RESTORED as primary 2026-07-19 — verified against
        // OpenRouter's live pricing it's the CHEAPEST of these three (10x cheaper per
        // token than claude-haiku-4.5), so removing it likely increased spend rather
        // than cutting it. See lib/arcus/engine.ts for the full pricing verification.
        // Also fixed claude-haiku-5 -> claude-haiku-4.5 here: -5 is a DEAD id (HTTP 400,
        // per lib/arcus/engine.ts).
        return custom.length ? custom : ['google/gemini-2.5-flash-lite', 'anthropic/claude-haiku-4.5', 'google/gemini-2.5-flash'];
    }
