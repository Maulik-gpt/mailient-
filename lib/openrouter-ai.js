...
export class OpenRouterAIService {
    constructor() {
        ...
        // Use Qwen3 Coder as primary - best available free model on OpenRouter
        this.model = 'qwen/qwen3-coder:free';

        // Same fallback for specialized tasks
        this.specializedModel = 'qwen/qwen3-coder:free';
        ...
        if (this.model && !this.model.includes('/')) {
            console.warn(`⚠️ Invalid model format "${this.model}". Falling back to Qwen3 Coder.`);
            this.model = 'qwen/qwen3-coder:free';
        }
    }

    async callOpenRouter(messages, options = {}) {
        // OPTIMIZED: Prioritize stable and high-quality free models (updated Jan 2026)
        const models = [
