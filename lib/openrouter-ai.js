...
CRITICAL RULES - VIOLATING ANY OF THESE IS UNACCEPTABLE:
1. IMPORTANT: Think and reason about the user's voice profile and context FIRST. Write your reasoning inside <thinking>...</thinking> tags.
2. After your thinking is complete, output the actual email reply.
3. Start immediately with the email content. First word must be part of the actual reply (e.g., "thanks", "hey", "appreciate", "sounds good").
4. Maximum ${tone === 'concise' ? '50' : '120'} words. No em dashes. Use commas/periods only.
5. Follow voice profile greeting/sign-off patterns exactly.

OUTPUT FORMAT: You MUST wrap your final email body in <email> and </email> tags. All thinking must happen outside these tags. Example: <thinking>Context dictates...</thinking><email>Hey there, thanks!</email>${securityInstruction}`;
            } else {
...
CRITICAL RULES - VIOLATING ANY OF THESE IS UNACCEPTABLE:
1. IMPORTANT: Think and reason about the context FIRST. Write your reasoning inside <thinking>...</thinking> tags.
2. After your thinking is complete, output the actual email reply.
3. Start immediately with the email content. First word must be part of the actual reply (e.g., "thanks", "hey", "appreciate", "sounds good").
4. Maximum ${tone === 'concise' ? '50' : '120'} words. No em dashes. Use commas/periods.
5. Sound natural and human.

OUTPUT FORMAT: You MUST wrap your final email body in <email> and </email> tags. All thinking must happen outside these tags. Example: <thinking>Context dictates...</thinking><email>Hey there, thanks!</email>`;
            }
