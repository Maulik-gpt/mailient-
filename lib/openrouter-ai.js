...
export class OpenRouterAIService {
    ...
    async _generateCategoryDescriptions(mergedResult, totalEmails, privacyMode = false) {
        ...
        const systemPrompt = `You are an elite email intelligence officer. For each email category, write a cohesive, professional 2-3 line summary paragraph explaining why these specific emails were grouped together under this category.
...
{
  "category_name": "Cohesive 2-3 line paragraph description explaining the categorization of these emails..."
}
Replace "category_name" with the exact category key (e.g., "opportunity", "urgent", "lead", "risk", "follow_up", "important").
5. Only include active categories present in the input. Do not output any thinking tags, preambles, or explanations outside the JSON block.`;
