...
export class OpenRouterAIService {
    ...
    constructor() {
        // Standardized strictly on fast Llama models to prevent DeepSeek R1 from causing 504 timeouts by over-thinking
        this.model = 'meta-llama/llama-3.3-70b-instruct:free';
        this.fallbackModels = ['meta-llama/llama-3.1-8b-instruct:free', 'openrouter/free'];
        ...
        this.specializedModel = 'meta-llama/llama-3.3-70b-instruct:free';
        this.voiceCloningModel = 'meta-llama/llama-3.3-70b-instruct:free';
