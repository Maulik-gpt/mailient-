...
export class OpenRouterAIService {
    ...
    // nemotron-3-super-120b:free and gemma-4-31b-it:free REMOVED 2026-07-19
    ...
    // token, so drafts use a smaller fast free model that streams quickly and is
    // plenty for a short voice-matched reply. Used by generateDraftReplyStream.
    // gemma-4-31b-it:free and nemotron-3-nano-30b:free REMOVED 2026-07-19 (user
    // report: not working).
    static DRAFT_MODELS = ['google/gemma-4-26b-a4b-it:free'];
