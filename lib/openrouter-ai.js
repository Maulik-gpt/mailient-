...
RULES:
1. Write ONLY the email reply. NO thinking, NO reasoning, NO explanations.
2. Never output phrases like "We need to", "I should", "Given the", "However", "Let's see", or any meta-commentary.
3. NO em dashes (—). Use commas or periods only.
4. Maximum ${tone === 'concise' ? '50' : '120'} words.
5. Follow the voice profile greeting/sign-off patterns exactly.

OUTPUT ONLY THIS:
[Greeting if voice profile uses one]
[Body responding to the email]
[Sign-off if voice profile uses one]${securityInstruction}`;
            } else {
...
RULES:
1. Write ONLY the email reply. NO thinking, NO reasoning, NO explanations.
2. Never output phrases like "We need to", "I should", "Given the", "However", or any meta-commentary.
...
Body responding to their message
