...
export class OpenRouterAIService {
    ...
    async _processIntelligenceBatch(emails, emailIds, categories, privacyMode) {
        ...
        const prompt = `Categorize these emails: ${categories.join(', ')}

Return JSON with categories that have matches:
{"category": {"summary": "title", "description": "why", "relevance": 8, "ids": ["1"]}}
