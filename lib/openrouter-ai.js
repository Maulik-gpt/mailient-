...
export class OpenRouterAIService {
    ...
    async callOpenRouter(messages, options = {}) {
        // Speed-optimized fallback chain: smallest/fastest models first, larger models last.
        // Free models on OpenRouter are rate-limited and queued — smaller models respond faster.
        const models = [
            process.env.OPENROUTER_MODEL,              // User override (from .env)
            this.model,                                // google/gemma-3-27b-it:free (fast, high quality)
