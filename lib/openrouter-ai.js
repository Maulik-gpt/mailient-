    ...
    async generateDraftReply(emailContent, category, userContext = {}, privacyMode = false) {
        try {
            ...
            const messages = [
                {
                    role: 'system',
                    content: `You are ARCUS, the intelligent conversational engine of Mailient. You write with a "human soul"—thoughtful, warm, and professional. ${roleInfo}${goalsInfo}
...
- Simple sign-off (${userName})`
                ...
                { role: 'user', content: `Draft a soulful professional reply to this email from ${fromName}:\n\n${cleanContent}` }
            ];
