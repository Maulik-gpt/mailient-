...
export class OpenRouterAIService {
    ...
    static premiumModels() {
        ...
        // verified live ($0.070/$0.340 per 1M), and its :free twin is already used
        // in engine.ts's free-model chain, so it's proven for tool-calling here.
        // flash-lite is 2nd-cheapest ($0.10/$0.40). See lib/arcus/engine.ts's
        // PAID_MODELS comment for the full pricing table and history.
        // Also fixed claude-haiku-5 -> claude-haiku-4.5 here: -5 is a DEAD id (HTTP 400,
        // per lib/arcus/engine.ts).
        return custom.length ? custom : ['google/gemma-4-26b-a4b-it', 'google/gemini-2.5-flash-lite', 'anthropic/claude-haiku-4.5', 'google/gemini-2.5-flash'];
    }
