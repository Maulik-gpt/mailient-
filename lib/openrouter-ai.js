...
export class OpenRouterAIService {
    constructor() {
        // Use reliable paid models for high-quality email analysis
        // anthropic/claude-3.5-sonnet for complex analysis, openai/gpt-4o-mini for speed
        this.model = process.env.OPENROUTER_MODEL || 'anthropic/claude-3.5-sonnet';
        this.fallbackModel = process.env.OPENROUTER_FALLBACK_MODEL || 'openai/gpt-4o-mini';
        ...
        if (this.apiKeys.length === 0) {
            ...
            console.log(`🔑 AI Service: ${this.apiKeys.length} key(s) | Primary: ${this.model} | Fallback: ${this.fallbackModel}`);
        }
