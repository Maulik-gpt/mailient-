...
2. Follow the voice profile EXACTLY for greetings and sign-offs.
3. Keep the email well-formatted (paragraphs, proper capitalization).
4. Address the context of the email clearly and effectively.
5. Maximum ${tone === 'concise' ? '50' : '150'} words. No em dashes (use commas/periods).

OUTPUT FORMAT: You MUST wrap your final email body in <email> and </email> tags. Example: <email>Hey there,\n\nThanks for reaching out!</email>${securityInstruction}`;
            } else {
