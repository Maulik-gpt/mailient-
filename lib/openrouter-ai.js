...
Return ONLY valid JSON in this exact format:
{
  "opportunity": {
    ...
    "description": "Write a beautiful, premium, highly readable description formatted in Markdown (use bullet points, bold text, and paragraphs). This will be displayed directly to the user. DO NOT output raw data or JSON structures here.",
    "relevance": 8,
    "ids": ["1", "2"]
  }
}
Provide an entry for each category. If no emails match a category, leave its "ids" array empty. Output ONLY the raw JSON string.
