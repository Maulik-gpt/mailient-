...
export class OpenRouterAIService {
    ...
    static premiumModels() {
        ...
        // per lib/arcus/engine.ts). It never mattered while flash-lite led this list and
        // always succeeded first; removing flash-lite would have made this dead id the
        // new primary and broken the whole paid fallback for every caller of this file.
        return custom.length ? custom : ['anthropic/claude-haiku-4.5', 'google/gemini-2.5-flash'];
    }
