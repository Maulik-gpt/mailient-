...
`;
    ...
    async generateInboxIntelligence(gmailData, privacyMode = false) {
        ...
        const runBatch = async (batchEmails, batchIndex) => {
            ...
            {
                "opportunity": { "title": "Strategic Opportunities", "summary": "...", "relevance": 1-10, "ids": [indices] },
                "urgent": { "title": "Critical / Urgent", "summary": "...", "relevance": 1-10, "ids": [indices] },
                "lead": { "title": "Growth & Leads", "summary": "...", "relevance": 1-10, "ids": [indices] },
                "risk": { "title": "Operational Risks", "summary": "...", "relevance": 1-10, "ids": [indices] },
                "follow_up": { "title": "Pending Follow-ups", "summary": "...", "relevance": 1-10, "ids": [indices] },
                "important": { "title": "Key Updates", "summary": "...", "relevance": 1-10, "ids": [indices] }
            }
        ...
        const batchResults = await Promise.all(batches.map((batch, i) => runBatch(batch, i)));
