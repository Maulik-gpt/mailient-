...
export class OpenRouterAIService {
    constructor() {
        ...
        // Use DeepSeek R1 as primary - best reasoning free model on OpenRouter
        this.model = 'deepseek/deepseek-r1-0528:free';

        // Same for specialized tasks
        this.specializedModel = 'deepseek/deepseek-r1-0528:free';
        ...
        if (this.model && !this.model.includes('/')) {
            console.warn(`⚠️ Invalid model format "${this.model}". Falling back to DeepSeek R1.`);
            this.model = 'deepseek/deepseek-r1-0528:free';
        }
    }
