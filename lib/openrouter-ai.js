...
export class OpenRouterAIService {
    constructor() {
        ...
        // StepFun Step-3.5-Flash: fast, reliable free model on OpenRouter
        this.model = 'stepfun/step-3.5-flash:free';

        // Same model for specialized tasks (drafts, notes, etc.)
        ...
        // Voice Cloning uses the same model for consistency
    ...
    async callOpenRouter(messages, options = {}) {
        // MAILIENT POLICY: Always use Arcee Trinity Large Preview (free)
        // This ensures we only ever consume the free Arcee model for all generic AI calls.
        const models = [
    ...
    async callOpenRouterWithModel(messages, options = {}, model = null, apiKey = null) {
        // MAILIENT POLICY: Force all specialized calls to Arcee Trinity Large Preview (free)
        const models = [
            model || this.model || 'arcee-ai/trinity-large-preview:free'
        ];
