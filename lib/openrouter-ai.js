        ...
        try {
            ...
            return await Promise.race([
                (async () => {
                    ...
                    console.log(`📡 [Sift AI] Analysis started for ${totalEmails.length} emails in ${batches.length} batches...`);
...
STRICT RULE: Only output the formatted lines. No conversational text.`;
        ...
        try {
            ...
            console.log(`✅ [Sift AI] Batch analysis complete. Classified ${results.length} emails.`);
            return results;
        } catch (e) {
