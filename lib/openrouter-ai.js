...
export class OpenRouterAIService {
    ...
    // Live-verified free model ids (2026-06). 'z-ai/glm-4.5-air:free' removed —
    // moved to paid-only, now 404s. 'openrouter/free' was never a real id.
    static FREE_MODELS = [
    ...
    // Draft replies must feel INSTANT (<5s). A 120B model is slow to first
    // token; smaller models (gemma-4-31b, gpt-oss-20b) stream much faster and
    // are plenty for a short voice-matched reply. Used by generateDraftReplyStream.
    static DRAFT_MODELS = ['google/gemma-4-31b-it:free', 'openai/gpt-oss-20b:free', 'openai/gpt-oss-120b:free'];
