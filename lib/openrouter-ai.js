...
export class OpenRouterAIService {
    constructor() {
        ...
        // Use Trinity Large Preview as primary - faster and more accurate free model on OpenRouter
        this.model = 'arcee-ai/trinity-large-preview:free';

        // Same fallback for specialized tasks
        this.specializedModel = 'arcee-ai/trinity-large-preview:free';
        ...
        this.voiceCloningModel = 'qwen/qwen3-coder:free';
        ...
        if (this.model && !this.model.includes('/')) {
            console.warn(`⚠️ Invalid model format "${this.model}". Falling back to Trinity Large Preview.`);
            this.model = 'arcee-ai/trinity-large-preview:free';
        }
    }
    ...
    async callOpenRouter(messages, options = {}) {
        ...
        for (const modelId of models) {
            try {
                ...
                // Add 8 second timeout per model attempt
