...
Return ONLY valid JSON in this exact format:
{
  "opportunity": {
    ...
    "description": "Detailed description of what the emails in this category are about.",
    "relevance": 8,
    "ids": ["1", "2"]
  }
}
Provide an entry for each category. If no emails match a category, leave its "ids" array empty. Do not include markdown formatting, just the raw JSON string.
