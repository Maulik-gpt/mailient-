...
export class OpenRouterAIService {
    ...
    async callOpenRouter(messages, options = {}) {
        ...
        console.log('🤖 [callOpenRouter] Starting request. Keys available:', keys.length);
        console.log('🤖 [callOpenRouter] Model:', this.model);
        
        if (keys.length === 0) {
            console.error('🛑 [callOpenRouter] NO API KEYS AVAILABLE');
            ...
            for (const modelId of models) {
                try {
                    ...
                    if (!response.ok) {
                        ...
                        console.error(`🛑 [callOpenRouter] REQUEST FAILED:`);
