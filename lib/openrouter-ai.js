        ...
        try {
            ...
            return await Promise.race([
                (async () => {
                    ...
                    // Build final descriptions from reasons
                    categories.forEach(cat => {
                        if (mergedResult[cat].reasons.length > 0) {
                            // Take top 3 most unique reasons to avoid clutter
                            const uniqueReasons = [...new Set(mergedResult[cat].reasons)].slice(0, 3);
