...
- Confidence: ${confidenceLabel} (${tone.confidence || 30}/100)`;
        ...
        if (customInstructions.trim()) {
            fragment += `\n\n[CRITICAL DIRECTIVE]: ${customInstructions.trim()}\n*You MUST follow the above directive strictly without exception or deviation. It is the absolute highest priority rule.*`;
        }
