    ...
    entries: [
      {
        ...
        points: [
          ...
          'A new Outreach command center tracks the whole motion: funnel, live drafts, replies lane, and campaign controls. Your home feed pings you when drafts await approval or replies land.',
        ],
      },
      {
        tag: 'Fixed',
