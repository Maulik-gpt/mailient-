...
export async function GET(request: Request) {
  try {
    ...
    // Phase 1: Fetch recent emails for analysis - fixed to 20 for maximum speed and stability
    ...
    // Use combined IDs for analysis (Optimized 20 limit for speed and stability)
