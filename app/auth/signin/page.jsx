    ...
    >
      ...
      <div className="relative w-full h-full bg-white/95 backdrop-blur-2xl rounded-full flex items-center justify-center gap-3 border border-white/20 shadow-[inset_0_1.5px_2px_rgba(255,255,255,0.9),inset_0_-1px_1px_rgba(0,0,0,0.05)] overflow-hidden">
        ...
        {isLoading ? (
          ...
          <>
            <div className="w-7 h-7 bg-white rounded-full flex items-center justify-center shadow-[0_2px_8px_rgba(0,0,0,0.08)] group-hover:scale-110 transition-transform duration-500 border border-black/[0.03]">
            ...
            <span className="text-[14px] text-zinc-900 font-bold tracking-tight">Sign in with Google</span>
          </>
        )}
      </div>
    </button>
