        ...
        <div className="flex h-screen w-full text-graphite-text bg-black selection:bg-white selection:text-black overflow-hidden relative tracking-tight">
          ...
          <div className={cn(
            ...
            <div className="flex-1 flex flex-col relative min-w-[500px] h-full transition-all duration-500 order-1 bg-[#161616] border-x border-t border-white/5 rounded-t-[32px] shadow-2xl overflow-hidden">
              ...
              <div className="flex-1 relative z-20 min-h-0 overflow-hidden">
                ...
                {!isInitialMode && (
                  <div className="absolute bottom-0 left-0 right-0 z-30 px-6 pb-6 pt-2 bg-[#161616]">
                    <div className="absolute bottom-full left-0 right-0 h-20 bg-gradient-to-t from-[#161616] via-[#161616] to-transparent pointer-events-none" />
