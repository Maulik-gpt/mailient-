...
export function SalesAgentWidget() {
    ...
    const conversation = useConversation({
        onConnect: () => console.log("[SalesAgent] Connected"),
        onDisconnect: () => console.log("[SalesAgent] Disconnected"),
        onMessage: (message) => console.log("[SalesAgent] Message:", message),
        onError: (error) => console.error("[SalesAgent] Error:", error),
    })
    ...
    const startConversation = useCallback(async () => {
        try {
            ...
            console.error("[SalesAgent] Failed to start:", error)
        }
    }, [conversation])
    ...
    const stopConversation = useCallback(async () => {
        try {
            ...
            console.error("[SalesAgent] Failed to stop:", error)
        }
    }, [conversation])
            ...
            <AnimatePresence>
                {!isOpen && (
                    <motion.button
                        ...
                        aria-label="Talk to Sales Agent"
                    ...
                    >
                        ...
                        <div className="relative z-10 flex items-center justify-between px-5 py-4 border-b border-white/[0.06]">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-sm font-bold text-white leading-none">Sales Agent</h3>
