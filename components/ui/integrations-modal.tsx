                ...
                return isComingSoon ? (
                  <Tooltip key={integration.id}>
                    <TooltipTrigger asChild>
                      <div className="flex items-center justify-between py-3 px-2 rounded-lg hover:bg-white/5 transition-all duration-200">
                        <div className="flex items-center gap-3">
                          <button
                            onClick={() => handleRemove(integration.id)}
                            disabled={integration.disabled}
                            className={`w-6 h-6 flex items-center justify-center text-white/80 ${integration.disabled ? '' : 'cursor-pointer hover:text-white'}`}
