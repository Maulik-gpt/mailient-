                        ...
                        <AnimatePresence mode="wait">
                            {activeSection === 'general' && (
                                <motion.div
                                    ...
                                    className="space-y-6"
                                >
                                    <div className="bg-black/5 dark:bg-white/5 rounded-3xl p-8 border border-neutral-200 dark:border-white/5 space-y-8">
                            ...
                            {activeSection === 'system' && (
                                ...
                                >
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="bg-black/5 dark:bg-white/5 rounded-[24px] p-6 border border-neutral-200 dark:border-white/5 flex items-center justify-center gap-4">
                                            <Button
                                                variant="outline"
                                                onClick={resetCache}
                            ...
                            {activeSection === 'account' && (
                                ...
                                >
                                    <div className="bg-black/5 dark:bg-white/5 rounded-[16px] p-1 border border-neutral-200 dark:border-white/5 overflow-hidden">
                                    <div className="p-8 space-y-10">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <input
                                                    ...
                                                    className="bg-black/5 dark:bg-white/5 border border-neutral-200 dark:border-white/10 rounded-xl px-4 py-2 text-[15px] text-black dark:text-white w-64 focus:ring-2 focus:ring-white transition-all outline-none"
                                                />
                                            </div>
                                            <div className="h-px bg-black/5 dark:bg-white/5" />
                                            <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        ...
                                                        className="bg-black/5 dark:bg-white/5 border border-neutral-200 dark:border-white/10 rounded-xl pl-8 pr-4 py-2 text-[15px] text-black dark:text-white w-64 focus:ring-2 focus:ring-white transition-all outline-none"
                                            ...
                                            <div className="space-y-8">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <Button 
                                                        ...
                                                        className="border-neutral-200 dark:border-white/10 text-black dark:text-white hover:bg-black/5 dark:bg-white/5 rounded-xl h-10 px-4 flex items-center gap-2"
                                                    >
                                                ...
                                                <div className="space-y-6 pt-4">
                                                    ...
                                                    <div className="bg-black/5 dark:bg-white/5 border border-neutral-200 dark:border-white/5 rounded-3xl overflow-hidden">
