...
const Skiper41 = () => {
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center bg-[#000000] text-white/40">
      <ProgressiveBlur position="top" backgroundColor="#000000" />
      <ProgressiveBlur position="bottom" backgroundColor="#000000" />
      ...
      <div className="flex h-[calc(100vh-1rem)] w-full flex-col items-center overflow-scroll">
        ...
        <div className="mt-24 w-full max-w-lg space-y-20 px-5 text-justify text-neutral-400">
