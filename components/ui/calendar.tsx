    ...
    return (
      <div className="flex justify-center items-center gap-3 pt-1 relative w-full mb-2">
        <select
          ...
          className="bg-white dark:bg-[#1a1a1a] border border-gray-700 text-white text-sm font-medium px-3 py-1.5 rounded-md focus:outline-none focus:ring-2 focus:ring-white/20 cursor-pointer appearance-none pr-8 hover:border-gray-600 transition-colors z-10"
          style={{
        ...
        >
          {years.map((year) => (
            <option key={year} value={year} className="bg-white dark:bg-[#1a1a1a] text-white">
              {year}
            </option>
          ))}
        </select>
