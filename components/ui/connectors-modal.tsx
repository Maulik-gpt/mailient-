            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
              {SUPPORTED_APPS.map((app) => {
                ...
                return (
                  ...
                  >
                    <div 
                      className="w-12 h-12 rounded-[16px] flex items-center justify-center bg-black/40 border border-white/[0.05] shrink-0 shadow-lg group-hover:scale-105 transition-transform p-2.5"
                    >
                      <app.icon />
                    </div>
