  ...
  return (
    <section className="py-32">
      <div className="container">
        ...
        <div className="mx-auto mt-16 max-w-3xl space-y-16 md:mt-24 md:space-y-24 px-6 pb-24">
          {entries.map((entry, index) => (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                {entry.button && (
                  <Button variant="link" className="mt-4 self-end text-black dark:text-white" asChild>
